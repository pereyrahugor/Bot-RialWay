// Autentica al usuario contra /api/backoffice/auth y guarda el token en localStorage.
// Si el target es "system-config" guarda system_config_token y redirige allí;
// en caso contrario guarda backoffice_token y redirige a /backoffice.
...
// Dispara login() al presionar Enter en cualquier campo del formulario.
