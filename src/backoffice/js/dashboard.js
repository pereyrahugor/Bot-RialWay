/* global logout */
// Obtiene el estado del bot desde /api/dashboard-status y llama a renderProviderStatus.
// Si hay proveedor dual (adapter + group), llama dos veces con etiquetas distintas.
// Se autolanza cada 15 s con setInterval.
...
// Actualiza los elementos del DOM (statusEl, qrSection, sessionInfo) según el estado del proveedor.
// Recibe el objeto status del servidor, una etiqueta legible y si es el proveedor de grupos.
...
// Redirige a /webreset cuando el usuario hace click en el botón de reinicio del dashboard.
