...
// Valida la contraseña del overlay de acceso admin. Si es correcta oculta el overlay,
// muestra el contenido principal y guarda los tokens en localStorage.
// Refresca el editor CodeMirror (window.cmEditor) si ya existe.
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Obtiene las variables de configuración desde /api/backoffice/config y rellena los inputs del formulario.
    // Al terminar llama a loadEditorFromHidden para cargar el prompt en el editor CodeMirror.
    ...
    // Lee el valor del input oculto del asistente seleccionado y lo carga en el editor CodeMirror.
    // Llamada por loadVariables y por el listener del assistantSelect.
    ...
    // Alterna la visibilidad del panel lateral del editor de prompts y refresca CodeMirror.
    ...
    // Envía el prompt actualizado a /api/backoffice/update-prompt para sincronizarlo con el asistente de OpenAI.
    // Llamada desde el submit del formulario principal y desde el botón "Guardar prompt" individual.
