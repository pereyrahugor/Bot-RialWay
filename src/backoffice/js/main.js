...
// Recalcula la variable CSS --app-vh al real height visible (excluye la barra del browser).
// Llamada en resize, orientationchange, pageshow y eventos de visualViewport.
function setAppVh() {
...
// Lee los estilos computados del textarea para obtener min-height, max-height, line-height y padding.
// Devuelve { MIN_H, MAX_H, BASE_H }. Llamada al inicio y en cada resize para recalcular.
...
// Ajusta la altura del textarea al contenido: colapsa a BASE_H si está vacío,
// crece hasta MAX_H en caso contrario. Llamada en input y focus.
...
/* ============================================
   ...
   ============================================ */
// Lleva el scroll del contenedor de chat al fondo. Llamada en focus e input del textarea.
...
/* ============================================
   Envío de mensajes
   ============================================ */
// Envía el mensaje de texto al webchat vía POST /webchat-api y muestra la respuesta del bot.
// Llama a addMessage para renderizar cada burbuja; resetea el textarea con autosizeSmart.
...
if (fileInput) {
    fileInput.onchange = async function () {
        ...
        // Envía un archivo como base64 a /webchat-api. Llamada internamente para imágenes, audio, video y documentos.
        // Usa addMessage para mostrar la previsualización y la respuesta del bot.
...
// Agrega una burbuja de mensaje al contenedor #chat y reproduce un sonido si es del bot.
// type puede ser 'user' o 'bot'. Llamada por sendMessage y sendPayload.
