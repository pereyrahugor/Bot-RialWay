            ...
            <div class="meta-view-body" style="padding: 2rem 1.5rem; max-width: 600px; margin: 0 auto; display: flex; flex-direction: column; gap: 1.5rem;">
                ...
                <div class="glass-card" style="padding: 2rem; border-radius: 20px; border: 1px solid var(--border); background: var(--bg-card); width: 100%;">
                    ...
                    <div id="mp-disconnected-section" style="display: none;">
                        <div style="background: rgba(0, 158, 227, 0.05); border: 1px solid rgba(0, 158, 227, 0.2); border-radius: 12px; padding: 1rem; margin-bottom: 1.5rem;">
                            ...
                            <p style="margin: 0; font-size: 0.85rem; color: var(--text-muted); line-height: 1.4;">
                                Ingresá a <a href="https://www.mercadopago.com.ar/developers/panel" target="_blank" style="color: #009ee3; text-decoration: underline; font-weight: 600;">Mercado Pago Developers</a>, ve a tus Credenciales de Producción y copia el <strong>Production Access Token</strong> (empieza con <code>APP_USR-</code>).
                            </p>
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 1.5rem; text-align: left;">
                            <label style="font-size: 0.85rem; font-weight: 600; color: var(--text-main);">Access Token de Producción</label>
                            <input type="password" id="mp-token-input" class="crm-input" placeholder="APP_USR-XXXXXX-XXXXXX..." style="width: 100%; padding: 12px; border-radius: 10px; background: var(--bg-header); border: 1px solid var(--border); color: var(--text-main);">
                        </div>
                    ...
                    <div id="mp-connected-section" style="display: none;">
                        <div style="background: rgba(16, 185, 129, 0.05); border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 12px; padding: 1rem; margin-bottom: 1.5rem; text-align: center;">
                            <span style="font-size: 0.8rem; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; color: #10b981; display: inline-flex; align-items: center; gap: 6px;">
    ...
    async function init() {
        ...
        if (connectBtn) {
            connectBtn.addEventListener('click', async () => {
                ...
                connectBtn.innerHTML = '<i class="fas fa-circle-notch fa-spin"></i> Conectando...';
                ...
                try {
                    ...
                    connectBtn.innerHTML = '<i class="fas fa-plug"></i> Conectar Cuenta';
                }
            });
        }
