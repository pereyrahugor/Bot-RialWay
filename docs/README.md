...
Bot-RialWay es un bot de WhatsApp construido sobre el framework **BuilderBot**, utilizando el proveedor **Baileys**. Está diseñado para ejecutarse en entornos de nube como **Railway** y utiliza **Supabase** para la persistencia de sesiones.

### Tecnologías Principales
- **Backend**: Node.js (TypeScript)
- **Bot Framework**: [@builderbot/bot](https://builderbot.app/)
- **Provider**: Baileys
