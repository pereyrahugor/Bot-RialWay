...
## 🌐 API Reference
* [Dashboard y QR](api/dashboard.md)
* [WebChat](api/webchat.md)
* [Gestión de Sesión](api/session.md)
* [Variables Railway](api/variables.md)
* [Control del Bot](api/restart.md)
* [Información del Asistente](api/assistant.md)

## 💬 WhatsApp Bot
* [Flujos de Bienvenida](whatsapp/flujos-bienvenida.md)
...
* [Google Integration](modulos/google-api.md)
* [Railway API](modulos/railway-api.md)
* [Database & Supabase](modulos/database.md)
* [Persistencia de Sesión](modulos/session-sync.md)
